...
from encoders.utils import counter, get_logger, load_config, mult_diag
...
def ridge_regression_huth(
    ...
    """Runs CVRidgeRegression on given train stories, returns scores for
    test story, regression weights, and the best alphas. Instead of using RidgeCV from sklearn,
    uses the Huth lab's implementation (https://github.com/HuthLab/deep-fMRI-dataset/blob/master/encoding/ridge_utils/ridge.py).
